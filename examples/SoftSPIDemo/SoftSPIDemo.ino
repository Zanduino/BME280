...
directly, the hardware used to develop this library is a breakout board from AdaFruit which is well-
documented at
...
** MOSI - Mast Out,  Slave In. Wire used to send data from the program to BME280   **
