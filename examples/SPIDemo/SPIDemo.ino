...
This example program initializes the BME280 to use I2C for communications. The library does not use
floating point mathematics to save on computation space and time, the values for Temperature,
...
------- | ---------- | ---------- | ---------------------------------------------------
1.0.4   | 2020-12-07 | SV-Zanshin | Reformatted to clang-format
...
/***************************************************************************************************
 * @brief The pin used for slave-select can be freely chosen from the digital pins available. This
 ***
 **       is the default pin used on an Arduino MEGA2560 **
 ***************************************************************************************************/
